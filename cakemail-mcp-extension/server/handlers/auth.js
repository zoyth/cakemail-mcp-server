...
export async function handleGetTokenStatus(_args, api) {
    try {
...
export async function handleRefreshToken(args, api) {
    try {
...
export async function handleValidateToken(_args, api) {
    try {
...
export async function handleGetTokenScopes(_args, api) {
    try {
