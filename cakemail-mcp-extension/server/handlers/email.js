...
export async function handleSendEmail(args, api) {
    try {
        const { email, sender_id, subject, html_content, text_content, template_id, list_id, email_type = 'transactional' } = args;
...
export async function handleGetEmailStats(args, api) {
    try {
        const { interval: inputInterval = 'day', iso_time = false, start_time, end_time, providers, tags } = args;
