...
import { handleGetTokenStatus, handleRefreshToken, handleValidateToken, handleGetTokenScopes } from './auth.js';
import { handleGetSenders, handleCreateSender, handleGetSender, handleUpdateSender, handleDeleteSender, handleListConfirmedSenders } from './senders.js';
import { handleListCampaigns, handleGetLatestCampaigns, handleGetCampaign, handleCreateCampaign, handleUpdateCampaign, handleSendCampaign, handleDeleteCampaign, handleDebugCampaignAccess, handleRenderCampaign, handleSendTestEmail, handleScheduleCampaign, handleUnscheduleCampaign, handleRescheduleCampaign, handleSuspendCampaign, handleResumeCampaign, handleCancelCampaign, handleArchiveCampaign, handleUnarchiveCampaign, handleGetCampaignRevisions, handleGetCampaignLinks, handleCreateBEETemplate, handleValidateBEETemplate } from './campaigns.js';
import { handleSendEmail, handleGetEmail, handleRenderEmail, handleGetEmailLogs, handleGetEmailStats, handleSendTransactionalEmail, handleSendMarketingEmail, handleGetEmailLogsWithAnalysis } from './email.js';
import { handleGetCampaignLogs } from './logs.js';
import { 
// Campaign analytics
handleGetCampaignStats, handleGetCampaignLinksStats, 
// Email statistics
handleGetEmailStats as handleGetEmailStatsReports, 
// List and account stats
handleGetListStats as handleGetListStatsReports, handleGetAccountStats, handleGetActionStats, 
// Export management
handleListCampaignReportsExports, handleCreateCampaignReportsExport, handleGetCampaignReportsExport, handleDownloadCampaignReportsExport, handleDeleteCampaignReportsExport, handleListSuppressedEmailsExports, handleCreateSuppressedEmailsExport, handleGetSuppressedEmailsExport, handleDownloadSuppressedEmailsExport, handleDeleteSuppressedEmailsExport, 
// Debug utilities
handleDebugReportsAccess } from './reports/index.js';
import { handleGetSelfAccount, handleGetRetryConfig } from './account.js';
import { handleListSubAccounts, handleCreateSubAccount, handleGetSubAccount, handleUpdateSubAccount, handleDeleteSubAccount, handleSuspendSubAccount, handleUnsuspendSubAccount, handleVerifySubAccountEmail, handleResendVerificationEmail, handleConvertSubAccountToOrganization, handleDebugSubAccountAccess, handleExportSubAccounts } from './sub-accounts.js';
import { handleListLists, handleCreateList, handleGetList, handleUpdateList, handleDeleteList, handleArchiveList, handleGetListStats, handleGetListStatsTimeSeries, handleGetListMovementLogs } from './lists.js';
import { handleListTemplates, handleCreateTemplate, handleGetTemplate, handleUpdateTemplate, handleDeleteTemplate, handleDuplicateTemplate, handleRenderTemplate } from './templates.js';
import { handleListContacts, handleCreateContact, handleGetContact, handleUpdateContact, handleDeleteContact, handleUnsubscribeContact, handleImportContacts, handleTagContacts, handleUntagContacts, handleSearchContacts } from './contacts.js';
...
export async function handleToolCall(request, api) {
    if (isDebug)
        logger.info({ incoming: request }, 'Received tool call request');
    ...
    if (!handler) {
        ...
        if (isDebug)
            logger.info({ outgoing: response }, 'Sending tool call response');
        return response;
    }
    try {
        ...
        if (isDebug)
            logger.info({ outgoing: response, error }, 'Sending tool call error response');
        return response;
    }
}
