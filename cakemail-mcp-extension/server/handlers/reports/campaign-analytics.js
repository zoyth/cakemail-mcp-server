...
import { generateCampaignInsights, generateCampaignRecommendations, analyzeLinkStats, generateLinkInsights, generateLinkRecommendations, categorizeLinks } from './insights.js';
/**
 * Get detailed campaign performance statistics and analytics
 */
export async function handleGetCampaignStats(args, api) {
    try {
 ...
 */
export async function handleGetCampaignLinksStats(args, api) {
    try {
 ...
 */
export async function handleGetCampaignPerformanceSummary(args, api) {
    try {
...
//# sourceMappingURL=campaign-analytics.js.map