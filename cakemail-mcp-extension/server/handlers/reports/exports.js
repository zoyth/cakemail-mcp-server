 ...
 */
export async function handleListCampaignReportsExports(args, api) {
    try {
 ...
 */
export async function handleCreateCampaignReportsExport(args, api) {
    try {
        ...
        if (start_time)
            exportData.start_time = start_time;
        if (end_time)
            exportData.end_time = end_time;
 ...
 */
export async function handleGetCampaignReportsExport(args, api) {
    try {
 ...
 */
export async function handleDownloadCampaignReportsExport(args, api) {
    try {
        const { export_id, account_id } = args;
        if (!export_id) {
            return {
        ...
        if (result.data) {
            ...
            if (result.data.download_url) {
                ...
                if (result.data.file_name) {
                    response += `\n${formatKeyValue('File Name', result.data.file_name)}\n`;
                }
                if (result.data.file_size) {
                    response += `${formatKeyValue('File Size', formatFileSize(result.data.file_size))}\n`;
                }
                if (result.data.content_type) {
                    response += `${formatKeyValue('Content Type', result.data.content_type)}\n`;
                }
            }
            else {
 ...
 */
export async function handleDeleteCampaignReportsExport(args, api) {
    try {
        const { export_id, account_id } = args;
        if (!export_id) {
            return {
 ...
 */
export async function handleListSuppressedEmailsExports(args, api) {
    try {
 ...
 */
export async function handleCreateSuppressedEmailsExport(args, api) {
    try {
 ...
 */
export async function handleGetSuppressedEmailsExport(args, api) {
    try {
        const { export_id, account_id } = args;
        if (!export_id) {
            return {
 ...
 */
export async function handleDownloadSuppressedEmailsExport(args, api) {
    try {
        const { export_id, account_id } = args;
        if (!export_id) {
            return {
 ...
 */
export async function handleDeleteSuppressedEmailsExport(args, api) {
    try {
        const { export_id, account_id } = args;
        if (!export_id) {
            return {
