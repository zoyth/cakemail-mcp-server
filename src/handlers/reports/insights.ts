 ...
 */
export function generateEmailInsights(stats: any): string[] {
 ...
 */
export function generateEmailRecommendations(stats: any): string[] {
 ...
 */
export function generateListInsights(stats: any): string[] {
  const insights: string[] = [];
 ...
 */
export function generateListRecommendations(stats: any): string[] {
  const recommendations: string[] = [];
 ...
 */
export function generateAccountInsights(stats: any): string[] {
  const insights: string[] = [];
 ...
 */
export function generateAccountRecommendations(stats: any): string[] {
  const recommendations: string[] = [];
 ...
 */
export function generateActionInsights(stats: any): string[] {
  const insights: string[] = [];
 ...
 */
export function generateActionRecommendations(stats: any): string[] {
  const recommendations: string[] = [];
 ...
 */
export function generateLinkInsights(links: any[], stats: any): string[] {
  const insights: string[] = [];
 ...
 */
export function generateLinkRecommendations(links: any[], stats: any): string[] {
  const recommendations: string[] = [];
