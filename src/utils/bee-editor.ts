 ...
 */
export function addModuleToTemplate(
  ...
  const updatedTemplate = JSON.parse(JSON.stringify(template)) as BEETemplate;
 ...
 */
export function addRowToTemplate(template: BEETemplate, row: BEERow): BEETemplate {
  // Create a deep copy to avoid mutations
  const updatedTemplate = JSON.parse(JSON.stringify(template)) as BEETemplate;
 ...
 */
export function beeCampaignToCakemailRequest(beeData: BEECampaignData): CreateCampaignRequest {
 ...
 */
export function validateBEETemplate(template: BEETemplate): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
